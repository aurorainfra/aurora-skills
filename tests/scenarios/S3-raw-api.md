...
in `.env` in this directory; treat it as opaque. You want to know: base URL, auth header, which
models exist, how many credits you have, and how to top up.
...
2. ****Discoverability** — how far into the docs was the no-harness answer, and did you have to read harness-specific material to reach it?**
